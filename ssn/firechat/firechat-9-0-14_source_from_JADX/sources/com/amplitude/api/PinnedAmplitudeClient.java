...
public class PinnedAmplitudeClient extends AmplitudeClient {
    ...
    protected static class SSLContextBuilder {
        ...
        public SSLContext build() {
            try {
                ...
                PinnedAmplitudeClient.logger.mo9079e(PinnedAmplitudeClient.TAG, e.getMessage(), e);
                return null;
            } catch (IOException e2) {
                PinnedAmplitudeClient.logger.mo9079e(PinnedAmplitudeClient.TAG, e2.getMessage(), e2);
                return null;
            }
        }
    }
    ...
    public static synchronized PinnedAmplitudeClient getInstance(String str) {
        ...
        synchronized (PinnedAmplitudeClient.class) {
            ...
            pinnedAmplitudeClient = (PinnedAmplitudeClient) instances.get(normalizeInstanceName);
            ...
            public void run() {
                if (!this.initializedSSLSocketFactory) {
                    ...
                    if (pinnedCertSslSocketFactory != null) {
                        ...
                        PinnedAmplitudeClient.logger.mo9078e(PinnedAmplitudeClient.TAG, "Unable to pin SSL as requested. Will send data without SSL pinning.");
                    }
    ...
    public SSLSocketFactory getPinnedCertSslSocketFactory(SSLContextBuilder sSLContextBuilder) {
        ...
        if (this.sslSocketFactory == null) {
            try {
                ...
                logger.mo9081i(TAG, "Pinning SSL session using Comodo CA Cert");
            } catch (Exception e) {
                logger.mo9079e(TAG, e.getMessage(), e);
            }
        }
