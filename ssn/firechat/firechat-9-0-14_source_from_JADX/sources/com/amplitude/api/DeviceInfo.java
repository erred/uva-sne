...
public class DeviceInfo {
    ...
    private class CachedInfo {
        ...
        private String getCountry() {
            ...
            if (!C0532Utils.isEmptyString(countryFromLocation)) {
                return countryFromLocation;
            }
            String countryFromNetwork = getCountryFromNetwork();
            if (!C0532Utils.isEmptyString(countryFromNetwork)) {
        ...
        private String getAndCacheGoogleAdvertisingId() {
            try {
                ...
                AmplitudeLog.getLogger().mo9089w(DeviceInfo.TAG, "Google Play Services SDK not found!");
            } catch (InvocationTargetException unused2) {
                AmplitudeLog.getLogger().mo9089w(DeviceInfo.TAG, "Google Play Services not available");
            } catch (Exception e) {
                AmplitudeLog.getLogger().mo9079e(DeviceInfo.TAG, "Encountered an error connecting to Google Play Services", e);
            }
            return this.advertisingId;
        }
        ...
        private boolean checkGPSEnabled() {
            ...
            try {
                ...
                AmplitudeLog.getLogger().mo9089w(DeviceInfo.TAG, "Google Play Services Util not found!");
                return false;
                ...
                sb.append(e);
                logger.mo9089w(str, sb.toString());
                return false;
            }
        }
    }
    ...
    public Location getMostRecentLocation() {
        ...
        LocationManager locationManager = (LocationManager) this.context.getSystemService(Param.LOCATION);
