...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo16385id = 6, type = "android.accounts.Account")
    private Account zzs;

    @Constructor
    AuthAccountRequest(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) IBinder iBinder, @Param(mo16388id = 3) Scope[] scopeArr, @Param(mo16388id = 4) Integer num, @Param(mo16388id = 5) Integer num2, @Param(mo16388id = 6) Account account) {
        this.zzal = i;
        this.zzqv = iBinder;
        this.zzqw = scopeArr;
        this.zzqx = num;
