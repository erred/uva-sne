...
public final class zzaf {
    ...
    public static zza<Long> zzajg = zza.zzb("measurement.config.cache_time", 86400000, (long) DateUtils.MILLIS_PER_HOUR);
    ...
    public static zza<Long> zzajv = zza.zzb("measurement.upload.window_interval", (long) DateUtils.MILLIS_PER_HOUR, (long) DateUtils.MILLIS_PER_HOUR);
    public static zza<Long> zzajw = zza.zzb("measurement.upload.interval", (long) DateUtils.MILLIS_PER_HOUR, (long) DateUtils.MILLIS_PER_HOUR);
    ...
    public static zza<Long> zzaka = zza.zzb("measurement.alarm_manager.minimum_interval", (long) DateUtils.MILLIS_PER_MINUTE, (long) DateUtils.MILLIS_PER_MINUTE);
    ...
    public static zza<Long> zzakj = zza.zzb("measurement.service_client.idle_disconnect_millis", (long) RangedBeacon.DEFAULT_MAX_TRACKING_AGE, (long) RangedBeacon.DEFAULT_MAX_TRACKING_AGE);
