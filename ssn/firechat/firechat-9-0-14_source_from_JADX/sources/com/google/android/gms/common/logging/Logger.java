...
public class Logger {
    ...
    /* renamed from: d */
    public void mo16411d(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: d */
    public void mo16412d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: e */
    public void mo16413e(String str, Throwable th, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr), th);
    }

    /* renamed from: e */
    public void mo16414e(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: i */
    public void mo16418i(String str, Throwable th, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr), th);
    }

    /* renamed from: i */
    public void mo16419i(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: v */
    public void mo16422v(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: v */
    public void mo16423v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: w */
    public void mo16424w(String str, Throwable th, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr), th);
    }

    /* renamed from: w */
    public void mo16425w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    /* renamed from: w */
    public void mo16426w(Throwable th) {
        Log.w(this.mTag, th);
    }
