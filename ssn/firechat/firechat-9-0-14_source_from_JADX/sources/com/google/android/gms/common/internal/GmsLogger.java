...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo16294d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzl(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo16295d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: e */
    public final void mo16297e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzl(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo16298e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    /* renamed from: i */
    public final void mo16301i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzl(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo16302i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: v */
    public final void mo16307v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzl(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo16308v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: w */
    public final void mo16310w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzl(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo16311w(String str, String str2, Throwable th) {
        if (canLog(5)) {
