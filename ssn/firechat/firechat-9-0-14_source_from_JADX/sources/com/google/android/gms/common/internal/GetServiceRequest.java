...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) int i2, @Param(mo16388id = 3) int i3, @Param(mo16388id = 4) String str, @Param(mo16388id = 5) IBinder iBinder, @Param(mo16388id = 6) Scope[] scopeArr, @Param(mo16388id = 7) Bundle bundle, @Param(mo16388id = 8) Account account, @Param(mo16388id = 10) Feature[] featureArr, @Param(mo16388id = 11) Feature[] featureArr2, @Param(mo16388id = 12) boolean z) {
        this.version = i;
        this.zzst = i2;
        this.zzsu = i3;
