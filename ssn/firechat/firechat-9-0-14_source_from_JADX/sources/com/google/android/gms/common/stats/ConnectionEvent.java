...
public final class ConnectionEvent extends StatsEvent {
    ...
    @Field(getter = "getEventType", mo16385id = 12)
    private int zzxw;
    @Field(getter = "getCallingProcess", mo16385id = 4)
    private final String zzxx;
    @Field(getter = "getCallingService", mo16385id = 5)
    private final String zzxy;
    @Field(getter = "getTargetProcess", mo16385id = 6)
    private final String zzxz;
    @Field(getter = "getTargetService", mo16385id = 7)
    private final String zzya;
    @Field(getter = "getStackTrace", mo16385id = 8)
    private final String zzyb;
    @Field(getter = "getEventKey", mo16385id = 13)
    private final String zzyc;
    @Field(getter = "getElapsedRealtime", mo16385id = 10)
    private final long zzyd;
    @Field(getter = "getHeapAlloc", mo16385id = 11)
    private final long zzye;
    private long zzyf;

    @Constructor
    ConnectionEvent(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) long j, @Param(mo16388id = 12) int i2, @Param(mo16388id = 4) String str, @Param(mo16388id = 5) String str2, @Param(mo16388id = 6) String str3, @Param(mo16388id = 7) String str4, @Param(mo16388id = 8) String str5, @Param(mo16388id = 13) String str6, @Param(mo16388id = 10) long j2, @Param(mo16388id = 11) long j3) {
        this.zzal = i;
        this.zzxv = j;
        this.zzxw = i2;
        this.zzxx = str;
