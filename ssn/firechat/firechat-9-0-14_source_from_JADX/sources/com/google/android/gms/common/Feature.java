...
public class Feature extends AbstractSafeParcelable {
    ...
    @Field(getter = "getName", mo16385id = 1)
    private final String name;
    @Field(getter = "getOldVersion", mo16385id = 2)
    @Deprecated
    private final int zzaq;
    @Field(defaultValue = "-1", getter = "getVersion", mo16385id = 3)
    private final long zzar;

    @Constructor
    public Feature(@Param(mo16388id = 1) String str, @Param(mo16388id = 2) int i, @Param(mo16388id = 3) long j) {
        this.name = str;
        this.zzaq = i;
        this.zzar = j;
    }
