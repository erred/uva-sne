...
public final class zzh extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "Integer.MIN_VALUE", mo16385id = 11)
    public final long zzagd;
    @Field(mo16385id = 5)
    public final String zzage;
    @Field(mo16385id = 7)
    public final long zzagf;
    @Field(defaultValue = "true", mo16385id = 9)
    public final boolean zzagg;
    @Field(mo16385id = 13)
    public final long zzagh;
    @Field(defaultValue = "true", mo16385id = 16)
    public final boolean zzagi;
    @Field(defaultValue = "true", mo16385id = 17)
    ...
    @Constructor
    zzh(@Param(mo16388id = 2) String str, @Param(mo16388id = 3) String str2, @Param(mo16388id = 4) String str3, @Param(mo16388id = 5) String str4, @Param(mo16388id = 6) long j, @Param(mo16388id = 7) long j2, @Param(mo16388id = 8) String str5, @Param(mo16388id = 9) boolean z, @Param(mo16388id = 10) boolean z2, @Param(mo16388id = 11) long j3, @Param(mo16388id = 12) String str6, @Param(mo16388id = 13) long j4, @Param(mo16388id = 14) long j5, @Param(mo16388id = 15) int i, @Param(mo16388id = 16) boolean z3, @Param(mo16388id = 17) boolean z4, @Param(mo16388id = 18) boolean z5, @Param(mo16388id = 19) String str7) {
        this.packageName = str;
        this.zzafx = str2;
        this.zzts = str3;
        this.zzagd = j3;
