...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getWidth", mo16385id = 3)
    private final int zzps;
    @Field(getter = "getHeight", mo16385id = 4)
    private final int zzpt;
    @Field(getter = "getUrl", mo16385id = 2)
    private final Uri zzpu;

    @Constructor
    WebImage(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) Uri uri, @Param(mo16388id = 3) int i2, @Param(mo16388id = 4) int i3) {
        this.zzal = i;
        this.zzpu = uri;
        this.zzps = i2;
        this.zzpt = i3;
