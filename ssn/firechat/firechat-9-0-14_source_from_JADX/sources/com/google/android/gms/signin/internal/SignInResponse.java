...
public class SignInResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getResolveAccountResponse", mo16385id = 3)
    private final ResolveAccountResponse zzadu;
    @VersionField(mo16391id = 1)
    private final int zzal;
    @Field(getter = "getConnectionResult", mo16385id = 2)
    ...
    @Constructor
    SignInResponse(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) ConnectionResult connectionResult, @Param(mo16388id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zzal = i;
