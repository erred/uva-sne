...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "getScopes", mo16385id = 2)
    public final ArrayList<Scope> zzr;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo16385id = 3)
    public Account zzs;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo16385id = 4)
    public boolean zzt;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo16385id = 5)
    public final boolean zzu;
    /* access modifiers changed from: private */
    @Field(getter = "isForceCodeForRefreshToken", mo16385id = 6)
    public final boolean zzv;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo16385id = 7)
    public String zzw;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo16385id = 8)
    public String zzx;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo16385id = 9)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) ArrayList<Scope> arrayList, @Param(mo16388id = 3) Account account, @Param(mo16388id = 4) boolean z, @Param(mo16388id = 5) boolean z2, @Param(mo16388id = 6) boolean z3, @Param(mo16388id = 7) String str, @Param(mo16388id = 8) String str2, @Param(mo16388id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
