...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @VersionField(mo16391id = 1000)
    private final int zzal;
    @Field(getter = "getStatusCode", mo16385id = 3)
    private final int zzam;
    @Field(getter = "getColumns", mo16385id = 1)
    private final String[] zznm;
    private Bundle zznn;
    @Field(getter = "getWindows", mo16385id = 2)
    private final CursorWindow[] zzno;
    @Field(getter = "getMetadata", mo16385id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo16388id = 1000) int i, @Param(mo16388id = 1) String[] strArr, @Param(mo16388id = 2) CursorWindow[] cursorWindowArr, @Param(mo16388id = 3) int i2, @Param(mo16388id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zzns = true;
        this.zzal = i;
        this.zznm = strArr;
