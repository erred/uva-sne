...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo16385id = 3)
    private ConnectionResult zzeu;
    @Field(getter = "getSaveDefaultAccount", mo16385id = 4)
    private boolean zzhs;
    @Field(mo16385id = 2)
    private IBinder zzqv;
    @Field(getter = "isFromCrossClientAuth", mo16385id = 5)
    ...
    @Constructor
    ResolveAccountResponse(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) IBinder iBinder, @Param(mo16388id = 3) ConnectionResult connectionResult, @Param(mo16388id = 4) boolean z, @Param(mo16388id = 5) boolean z2) {
        this.zzal = i;
        this.zzqv = iBinder;
