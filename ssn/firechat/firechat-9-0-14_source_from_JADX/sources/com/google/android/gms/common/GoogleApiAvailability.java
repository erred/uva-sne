        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C1116R.C1117drawable.common_full_open_on_phone, resources.getString(C1116R.string.common_open_on_phone), pendingIntent);
                } else {
