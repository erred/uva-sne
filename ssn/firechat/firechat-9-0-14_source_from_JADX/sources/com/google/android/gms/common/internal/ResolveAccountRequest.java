...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getAccount", mo16385id = 2)
    private final Account zzs;
    @Field(getter = "getSessionId", mo16385id = 3)
    private final int zzut;
    @Field(getter = "getSignInAccountHint", mo16385id = 4)
    private final GoogleSignInAccount zzuu;

    @Constructor
    ResolveAccountRequest(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) Account account, @Param(mo16388id = 3) int i2, @Param(mo16388id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zzal = i;
        this.zzs = account;
        this.zzut = i2;
