...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo16385id = 1)
    private final int zzam;
    @Nullable
    @Field(getter = "getPendingIntent", mo16385id = 3)
    private final PendingIntent zzan;
    @Nullable
    @Field(getter = "getStatusMessage", mo16385id = 2)
    ...
    @Constructor
    @KeepForSdk
    Status(@Param(mo16388id = 1000) int i, @Param(mo16388id = 1) int i2, @Nullable @Param(mo16388id = 2) String str, @Nullable @Param(mo16388id = 3) PendingIntent pendingIntent) {
        this.zzal = i;
        this.zzam = i2;
        this.zzao = str;
