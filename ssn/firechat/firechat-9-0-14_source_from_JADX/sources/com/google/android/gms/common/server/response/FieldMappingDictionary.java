...
public class FieldMappingDictionary extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo16385id = 2)
    private final ArrayList<Entry> zzxl;
    @SafeParcelable.Field(getter = "getRootClassName", mo16385id = 3)
    ...
    public static class Entry extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(mo16385id = 2)
        final String className;
        @VersionField(mo16391id = 1)
        private final int versionCode;
        @SafeParcelable.Field(mo16385id = 3)
        final ArrayList<FieldMapPair> zzxn;

        @Constructor
        Entry(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) String str, @Param(mo16388id = 3) ArrayList<FieldMapPair> arrayList) {
            this.versionCode = i;
            this.className = str;
            this.zzxn = arrayList;
        }
    ...
    public static class FieldMapPair extends AbstractSafeParcelable {
        ...
        @Constructor
        FieldMapPair(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) String str, @Param(mo16388id = 3) Field<?, ?> field) {
            this.versionCode = i;
            this.zzxo = str;
            this.zzxp = field;
        }
    ...
    @Constructor
    FieldMappingDictionary(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) ArrayList<Entry> arrayList, @Param(mo16388id = 3) String str) {
        this.zzal = i;
        this.zzxl = null;
