...
public final class zzeq extends zzf {
    ...
    public final void zzal(long j) {
        ...
        if (zzgp().zzanr.get()) {
            ...
            this.zzasy.zzh(Math.max(0, DateUtils.MILLIS_PER_HOUR - zzgp().zzanu.get()));
        }
    }
    ...
    private final void zzao(long j) {
        ...
        if (zzgq().zzbi(zzgf().zzal())) {
            long j2 = j / 1000;
            zzge().zza(ReactScrollViewHelper.AUTO, "_sid", (Object) Long.valueOf(j2), j);
        } else {
            zzge().zza(ReactScrollViewHelper.AUTO, "_sid", (Object) null, j);
        }
        ...
        zzge().zza(ReactScrollViewHelper.AUTO, "_s", j, bundle);
        zzgp().zzant.set(j);
    }
    ...
    public final boolean zzn(boolean z) {
        ...
        if (z || j >= 1000) {
            ...
            zzge().logEvent(ReactScrollViewHelper.AUTO, "_e", bundle);
