...
public class RecordConsentRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopesToConsent", mo16385id = 3)
    private final Scope[] zzadr;
    @VersionField(mo16391id = 1)
    private final int zzal;
    @Field(getter = "getAccount", mo16385id = 2)
    private final Account zzs;
    @Field(getter = "getServerClientId", mo16385id = 4)
    private final String zzw;

    @Constructor
    RecordConsentRequest(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) Account account, @Param(mo16388id = 3) Scope[] scopeArr, @Param(mo16388id = 4) String str) {
        this.zzal = i;
        this.zzs = account;
        this.zzadr = scopeArr;
        this.zzw = str;
