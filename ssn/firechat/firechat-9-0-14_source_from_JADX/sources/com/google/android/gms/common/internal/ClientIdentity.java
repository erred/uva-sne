...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    @Nullable
    @Field(defaultValueUnchecked = "null", mo16385id = 2)
    public final String packageName;
    @Field(defaultValueUnchecked = "0", mo16385id = 1)
    public final int uid;

    @Constructor
    public ClientIdentity(@Param(mo16388id = 1) int i, @Nullable @Param(mo16388id = 2) String str) {
        this.uid = i;
