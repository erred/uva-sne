...
public class AuthAccountResult extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getConnectionResultCode", mo16385id = 2)
    private int zzadn;
    @Field(getter = "getRawAuthResolutionIntent", mo16385id = 3)
    ...
    @Constructor
    AuthAccountResult(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) int i2, @Param(mo16388id = 3) Intent intent) {
        this.zzal = i;
        this.zzadn = i2;
        this.zzado = intent;
    }
