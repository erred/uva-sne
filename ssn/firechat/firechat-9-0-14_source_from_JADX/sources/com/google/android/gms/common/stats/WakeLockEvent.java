...
public final class WakeLockEvent extends StatsEvent {
    ...
    @Field(getter = "getTimeout", mo16385id = 16)
    private final long mTimeout;
    @VersionField(mo16391id = 1)
    private final int zzal;
    @Field(getter = "getTimeMillis", mo16385id = 2)
    private final long zzxv;
    @Field(getter = "getEventType", mo16385id = 11)
    private int zzxw;
    @Field(getter = "getElapsedRealtime", mo16385id = 8)
    private final long zzyd;
    private long zzyf;
    @Field(getter = "getWakeLockName", mo16385id = 4)
    private final String zzyq;
    @Field(getter = "getSecondaryWakeLockName", mo16385id = 10)
    private final String zzyr;
    @Field(getter = "getCodePackage", mo16385id = 17)
    private final String zzys;
    @Field(getter = "getWakeLockType", mo16385id = 5)
    private final int zzyt;
    @Field(getter = "getCallingPackages", mo16385id = 6)
    private final List<String> zzyu;
    @Field(getter = "getEventKey", mo16385id = 12)
    private final String zzyv;
    @Field(getter = "getDeviceState", mo16385id = 14)
    private int zzyw;
    @Field(getter = "getHostPackage", mo16385id = 13)
    private final String zzyx;
    @Field(getter = "getBeginPowerPercentage", mo16385id = 15)
    private final float zzyy;

    @Constructor
    WakeLockEvent(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) long j, @Param(mo16388id = 11) int i2, @Param(mo16388id = 4) String str, @Param(mo16388id = 5) int i3, @Param(mo16388id = 6) List<String> list, @Param(mo16388id = 12) String str2, @Param(mo16388id = 8) long j2, @Param(mo16388id = 14) int i4, @Param(mo16388id = 10) String str3, @Param(mo16388id = 13) String str4, @Param(mo16388id = 15) float f, @Param(mo16388id = 16) long j3, @Param(mo16388id = 17) String str5) {
        this.zzal = i;
        this.zzxv = j;
        this.zzxw = i2;
        this.zzyq = str;
