...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo16385id = 3)
    private Bundle mBundle;
    @VersionField(mo16391id = 1)
    private final int versionCode;
    @Field(getter = "getType", mo16385id = 2)
    private int zzac;

    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo16388id = 1) int i, @TypeId @Param(mo16388id = 2) int i2, @Param(mo16388id = 3) Bundle bundle) {
        this.versionCode = i;
        this.zzac = i2;
        this.mBundle = bundle;
    }
