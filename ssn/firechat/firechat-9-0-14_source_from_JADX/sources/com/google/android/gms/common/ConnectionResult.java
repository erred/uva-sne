...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo16385id = 2)
    private final int zzam;
    @Field(getter = "getResolution", mo16385id = 3)
    private final PendingIntent zzan;
    @Field(getter = "getErrorMessage", mo16385id = 4)
    ...
    @Constructor
    ConnectionResult(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) int i2, @Param(mo16388id = 3) PendingIntent pendingIntent, @Param(mo16388id = 4) String str) {
        this.zzal = i;
        this.zzam = i2;
