...
public class SafeParcelResponse extends FastSafeParcelableJsonResponse {
    ...
    @Field(getter = "getFieldMappingDictionary", mo16385id = 3)
    private final FieldMappingDictionary zzwn;
    @Field(getter = "getParcel", mo16385id = 2)
    ...
    @Constructor
    SafeParcelResponse(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) Parcel parcel, @Param(mo16388id = 3) FieldMappingDictionary fieldMappingDictionary) {
        this.zzal = i;
