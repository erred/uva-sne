...
public class GoogleCertificatesQuery extends AbstractSafeParcelable {
    ...
    @Field(getter = "getCallingPackage", mo16385id = 1)
    private final String zzbh;
    @Field(getter = "getCallingCertificateBinder", mo16385id = 2, type = "android.os.IBinder")
    @Nullable
    private final CertData zzbi;
    @Field(getter = "getAllowTestKeys", mo16385id = 3)
    private final boolean zzbj;

    @Constructor
    GoogleCertificatesQuery(@Param(mo16388id = 1) String str, @Param(mo16388id = 2) @Nullable IBinder iBinder, @Param(mo16388id = 3) boolean z) {
        this.zzbh = str;
