...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo16385id = 4)
    @Deprecated
    private final Scope[] zzqw;
    @Field(getter = "getButtonSize", mo16385id = 2)
    private final int zzux;
    @Field(getter = "getColorScheme", mo16385id = 3)
    private final int zzuy;

    @Constructor
    SignInButtonConfig(@Param(mo16388id = 1) int i, @Param(mo16388id = 2) int i2, @Param(mo16388id = 3) int i3, @Param(mo16388id = 4) Scope[] scopeArr) {
        this.zzal = i;
        this.zzux = i2;
        this.zzuy = i3;
        this.zzqw = scopeArr;
