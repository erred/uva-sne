...
final class zzz {
    ...
    public final zzz zziu() {
        ...
        long j = this.zzaie + 1;
        long j2 = this.zzaif + 1;
        long j3 = this.zzaig;
        long j4 = this.zzaih;
        Long l = this.zzaii;
        Long l2 = l;
        zzz zzz = new zzz(str, str2, j, j2, j3, j4, l2, this.zzaij, this.zzaik, this.zzail);
        return zzz;
    }
    ...
    public final zzz zza(Long l, Long l2, Boolean bool) {
        zzz zzz = new zzz(this.zztt, this.name, this.zzaie, this.zzaif, this.zzaig, this.zzaih, this.zzaii, l, l2, (bool == null || bool.booleanValue()) ? bool : null);
        return zzz;
    }
}
