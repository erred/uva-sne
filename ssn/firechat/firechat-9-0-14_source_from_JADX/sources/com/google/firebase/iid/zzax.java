...
final class zzax {
    ...
    static zzax zzi(String str) {
        ...
        try {
            ...
            return new zzax(jSONObject.getString(VectorRegistrationReceiver.KEY_MAIL_VALIDATION_TOKEN), jSONObject.getString("appVersion"), jSONObject.getLong(Param.TIMESTAMP));
    ...
    static String zza(String str, String str2, long j) {
        try {
            ...
            jSONObject.put(VectorRegistrationReceiver.KEY_MAIL_VALIDATION_TOKEN, str);
