...
final class VectorSettingsPreferencesFragment$refreshPhoneNumbersList$2 implements OnPreferenceClickListener {
    final /* synthetic */ ThirdPartyIdentifier $phoneNumber3PID;
    final /* synthetic */ VectorSettingsPreferencesFragment this$0;

    VectorSettingsPreferencesFragment$refreshPhoneNumbersList$2(VectorSettingsPreferencesFragment vectorSettingsPreferencesFragment, ThirdPartyIdentifier thirdPartyIdentifier) {
    ...
    public final boolean onPreferenceClick(Preference preference) {
        ...
        ThirdPartyIdentifier thirdPartyIdentifier = this.$phoneNumber3PID;
        Intrinsics.checkExpressionValueIsNotNull(thirdPartyIdentifier, "phoneNumber3PID");
