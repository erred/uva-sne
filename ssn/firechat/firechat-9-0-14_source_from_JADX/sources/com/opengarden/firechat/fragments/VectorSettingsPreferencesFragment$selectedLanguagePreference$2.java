...
final class VectorSettingsPreferencesFragment$selectedLanguagePreference$2 extends Lambda implements Function0<VectorCustomActionEditTextPreference> {
    final /* synthetic */ VectorSettingsPreferencesFragment this$0;

    VectorSettingsPreferencesFragment$selectedLanguagePreference$2(VectorSettingsPreferencesFragment vectorSettingsPreferencesFragment) {
    ...
    public final VectorCustomActionEditTextPreference invoke() {
        Preference findPreference = this.this$0.findPreference(PreferencesManager.SETTINGS_INTERFACE_LANGUAGE_PREFERENCE_KEY);
