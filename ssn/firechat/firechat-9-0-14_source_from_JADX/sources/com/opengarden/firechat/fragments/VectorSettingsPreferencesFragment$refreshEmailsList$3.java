...
final class VectorSettingsPreferencesFragment$refreshEmailsList$3 implements OnPreferenceLongClickListener {
    final /* synthetic */ ThirdPartyIdentifier $email3PID;
    final /* synthetic */ VectorSettingsPreferencesFragment this$0;

    VectorSettingsPreferencesFragment$refreshEmailsList$3(VectorSettingsPreferencesFragment vectorSettingsPreferencesFragment, ThirdPartyIdentifier thirdPartyIdentifier) {
        this.this$0 = vectorSettingsPreferencesFragment;
        this.$email3PID = thirdPartyIdentifier;
    }

    public final boolean onPreferenceLongClick(Preference preference) {
        VectorUtils.copyToClipboard(this.this$0.getActivity(), this.$email3PID.address);
        return true;
    }
}
