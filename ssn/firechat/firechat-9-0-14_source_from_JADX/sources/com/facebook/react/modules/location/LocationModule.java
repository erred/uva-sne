...
public class LocationModule extends ReactContextBaseJavaModule {
    ...
    private static class LocationOptions {
        ...
        public static LocationOptions fromReactMap(ReadableMap readableMap) {
            LocationOptions locationOptions = new LocationOptions(readableMap.hasKey("timeout") ? (long) readableMap.getDouble("timeout") : Long.MAX_VALUE, readableMap.hasKey("maximumAge") ? readableMap.getDouble("maximumAge") : Double.POSITIVE_INFINITY, readableMap.hasKey("enableHighAccuracy") && readableMap.getBoolean("enableHighAccuracy"), readableMap.hasKey("distanceFilter") ? (float) readableMap.getDouble("distanceFilter") : 100.0f);
                ...
                public void run() {
                    synchronized (SingleUpdateRequest.this) {
                        if (!SingleUpdateRequest.this.mTriggered) {
                            ...
                            FLog.m77i(ReactConstants.TAG, "LocationModule: Location request timed out");
    ...
    public void getCurrentPosition(ReadableMap readableMap, Callback callback, Callback callback2) {
        ...
        try {
            ...
            if (validProvider == null) {
                callback2.invoke(PositionError.buildError(PositionError.PERMISSION_DENIED, "No location provider available."));
                return;
            }
