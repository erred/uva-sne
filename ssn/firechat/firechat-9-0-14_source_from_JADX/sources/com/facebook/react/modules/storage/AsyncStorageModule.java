            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                while (i < readableArray.size()) {
                    ...
                    try {
                        ...
                        Exception exc = e;
                        FLog.m106w(ReactConstants.TAG, exc.getMessage(), (Throwable) exc);
                        callback.invoke(AsyncStorageErrorUtil.getError(null, exc.getMessage()), null);
                        query.close();
                        return;
                    } catch (Throwable th) {
                        Throwable th2 = th;
                ...
                callback.invoke(null, writableArray2);
            }
        }.execute(new Void[0]);
    }
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    while (i < readableArray.size()) {
                        if (readableArray.getArray(i).size() != 2) {
                            ...
                            try {
                                ...
                                FLog.m106w(ReactConstants.TAG, e.getMessage(), (Throwable) e);
                            ...
                            try {
                                ...
                                FLog.m106w(ReactConstants.TAG, e2.getMessage(), (Throwable) e2);
                            ...
                            try {
                                ...
                                FLog.m106w(ReactConstants.TAG, e3.getMessage(), (Throwable) e3);
                    ...
                    try {
                        ...
                        FLog.m106w(ReactConstants.TAG, e4.getMessage(), (Throwable) e4);
                        writableMap = AsyncStorageErrorUtil.getError(null, e4.getMessage());
                    }
                } catch (Exception e5) {
                    FLog.m106w(ReactConstants.TAG, e5.getMessage(), (Throwable) e5);
                    WritableMap error = AsyncStorageErrorUtil.getError(null, e5.getMessage());
                    try {
                    } catch (Exception e6) {
                        FLog.m106w(ReactConstants.TAG, e6.getMessage(), (Throwable) e6);
                        if (error == null) {
                    ...
                    try {
                        ...
                        FLog.m106w(ReactConstants.TAG, e7.getMessage(), (Throwable) e7);
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                try {
                    ...
                    try {
                        ...
                        FLog.m106w(ReactConstants.TAG, e8.getMessage(), (Throwable) e8);
