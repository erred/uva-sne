...
public class TimePickerDialogFragment extends DialogFragment {
    ...
    static Dialog createDialog(Bundle bundle, Context context, @Nullable OnTimeSetListener onTimeSetListener) {
        ...
        if (bundle2 != null) {
            i = bundle2.getInt("hour", instance.get(11));
            i2 = bundle2.getInt("minute", instance.get(12));
            is24HourFormat = bundle2.getBoolean("is24Hour", DateFormat.is24HourFormat(context));
        }
