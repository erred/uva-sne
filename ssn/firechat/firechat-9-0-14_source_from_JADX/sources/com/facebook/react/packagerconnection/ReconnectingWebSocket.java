...
public final class ReconnectingWebSocket extends WebSocketListener {
    ...
    public synchronized void onOpen(WebSocket webSocket, C3012Response response) {
    ...
    public synchronized void onFailure(WebSocket webSocket, Throwable th, C3012Response response) {
        if (this.mWebSocket != null) {
