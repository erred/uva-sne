...
public class ReactRootView extends SizeMonitoringFrameLayout implements RootView, MeasureSpecProvider {
    ...
    private class CustomGlobalLayoutListener implements OnGlobalLayoutListener {
        ...
        private void sendEvent(String str, @Nullable WritableMap writableMap) {
            if (ReactRootView.this.mReactInstanceManager != null) {
                ((RCTDeviceEventEmitter) ReactRootView.this.mReactInstanceManager.getCurrentReactContext().getJSModule(RCTDeviceEventEmitter.class)).emit(str, writableMap);
            }
        }
    }
    ...
    public int getWidthMeasureSpec() {
        ...
        return MeasureSpec.makeMeasureSpec(getLayoutParams().width, ErrorDialogData.SUPPRESSED);
    }
    ...
    public int getHeightMeasureSpec() {
        ...
        return MeasureSpec.makeMeasureSpec(getLayoutParams().height, ErrorDialogData.SUPPRESSED);
    }
    ...
    public void onChildStartedNativeGesture(MotionEvent motionEvent) {
        if (this.mReactInstanceManager == null || !this.mIsAttachedToInstance || this.mReactInstanceManager.getCurrentReactContext() == null) {
            FLog.m105w(ReactConstants.TAG, "Unable to dispatch touch to JS as the catalyst instance has not been attached");
            return;
        }
    ...
    private void enableLayoutCalculation() {
        if (this.mReactInstanceManager == null) {
            FLog.m105w(ReactConstants.TAG, "Unable to enable layout calculation for uninitialized ReactInstanceManager");
            return;
        }
    ...
    private void updateRootLayoutSpecs(int i, int i2) {
        if (this.mReactInstanceManager == null) {
            FLog.m105w(ReactConstants.TAG, "Unable to update root layout specs for uninitialized ReactInstanceManager");
            return;
        }
        ReactContext currentReactContext = this.mReactInstanceManager.getCurrentReactContext();
        if (currentReactContext != null) {
            ...
            final int i3 = i;
            final int i4 = i2;
            C07601 r1 = new GuardedRunnable(currentReactContext) {
            ...
            currentReactContext.runUIBackgroundRunnable(r1);
        }
    }
