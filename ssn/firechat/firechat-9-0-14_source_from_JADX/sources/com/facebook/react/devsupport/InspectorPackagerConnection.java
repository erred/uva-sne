...
public class InspectorPackagerConnection {
    ...
    private class Connection extends WebSocketListener {
        ...
        public void onOpen(WebSocket webSocket, C3012Response response) {
            this.mWebSocket = webSocket;
        }

        public void onFailure(WebSocket webSocket, Throwable th, C3012Response response) {
        ...
        private void reconnect() {
            ...
            if (!this.mSuppressConnectionErrors) {
                FLog.m105w(InspectorPackagerConnection.TAG, "Couldn't connect to packager, will silently retry");
            ...
            new AsyncTask<WebSocket, Void, Void>() {
                ...
                public Void doInBackground(WebSocket... webSocketArr) {
                    ...
                    try {
                        ...
                        FLog.m106w(InspectorPackagerConnection.TAG, "Couldn't send event to packager", (Throwable) e);
                    }
                    return null;
                }
    ...
    private void handleConnect(JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            sb2.append("Failed to open page: ");
            sb2.append(string);
            FLog.m106w(str, sb2.toString(), (Throwable) e);
