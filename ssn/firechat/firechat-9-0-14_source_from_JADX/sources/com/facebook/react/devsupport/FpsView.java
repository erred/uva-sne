...
public class FpsView extends FrameLayout {
    ...
    private final TextView mTextView = ((TextView) findViewById(C0742R.C0744id.fps_text));
    ...
    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C0742R.layout.fps_view, this);
    ...
    public void setCurrentFPS(double d, double d2, int i, int i2) {
        ...
        FLog.m53d(ReactConstants.TAG, format);
    }
}
