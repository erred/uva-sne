...
public class StackTraceHelper {
    ...
    public static class StackFrameImpl implements StackFrame {
        ...
        public JSONObject toJSON() {
            return new JSONObject(MapBuilder.m141of(UriUtil.LOCAL_FILE_SCHEME, getFile(), "methodName", getMethod(), StackTraceHelper.LINE_NUMBER_KEY, Integer.valueOf(getLine()), StackTraceHelper.COLUMN_KEY, Integer.valueOf(getColumn())));
        }
    }
    ...
    public static StackFrame[] convertJsStackTrace(String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            if (matcher.find()) {
                StackFrameImpl stackFrameImpl = new StackFrameImpl(matcher.group(2), matcher.group(1) == null ? "(unknown)" : matcher.group(1), Integer.parseInt(matcher.group(3)), Integer.parseInt(matcher.group(4)));
                stackFrameArr[i] = stackFrameImpl;
            } else {
