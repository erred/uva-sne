...
public class FrescoBasedReactTextInlineImageShadowNode extends ReactTextInlineImageShadowNode {
    ...
    private static Uri getResourceDrawableUri(Context context, @Nullable String str) {
        ...
        return new Builder().scheme(UriUtil.LOCAL_RESOURCE_SCHEME).path(String.valueOf(context.getResources().getIdentifier(str.toLowerCase(Locale.getDefault()).replace(HelpFormatter.DEFAULT_OPT_PREFIX, "_"), "drawable", context.getPackageName()))).build();
    }
