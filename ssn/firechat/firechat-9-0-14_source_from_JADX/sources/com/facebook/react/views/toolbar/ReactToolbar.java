...
public class ReactToolbar extends Toolbar {
    ...
    private final Runnable mLayoutRunnable = new Runnable() {
        public void run() {
            ReactToolbar.this.measure(MeasureSpec.makeMeasureSpec(ReactToolbar.this.getWidth(), ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(ReactToolbar.this.getHeight(), ErrorDialogData.SUPPRESSED));
