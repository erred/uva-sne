...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout> {
    ...
    public void setElevation(ReactDrawerLayout reactDrawerLayout, float f) {
        if (VERSION.SDK_INT >= 21) {
            try {
                ...
                FLog.m106w(ReactConstants.TAG, "setDrawerElevation is not available in this version of the support lib.", (Throwable) e);
            }
        }
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m139of("openDrawer", Integer.valueOf(1), "closeDrawer", Integer.valueOf(2));
    }
