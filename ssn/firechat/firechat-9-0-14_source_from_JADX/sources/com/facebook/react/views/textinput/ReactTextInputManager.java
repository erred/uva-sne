...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        return MapBuilder.builder().put("topSubmitEditing", MapBuilder.m138of("phasedRegistrationNames", MapBuilder.m139of("bubbled", "onSubmitEditing", "captured", "onSubmitEditingCapture"))).put("topEndEditing", MapBuilder.m138of("phasedRegistrationNames", MapBuilder.m139of("bubbled", "onEndEditing", "captured", "onEndEditingCapture"))).put(ReactTextInputEvent.EVENT_NAME, MapBuilder.m138of("phasedRegistrationNames", MapBuilder.m139of("bubbled", "onTextInput", "captured", "onTextInputCapture"))).put("topFocus", MapBuilder.m138of("phasedRegistrationNames", MapBuilder.m139of("bubbled", "onFocus", "captured", "onFocusCapture"))).put("topBlur", MapBuilder.m138of("phasedRegistrationNames", MapBuilder.m139of("bubbled", "onBlur", "captured", "onBlurCapture"))).build();
    }

    @Nullable
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(ScrollEventType.SCROLL.getJSEventName(), MapBuilder.m138of("registrationName", "onScroll")).build();
    }

    @Nullable
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m139of("focusTextInput", Integer.valueOf(1), "blurTextInput", Integer.valueOf(2));
    }
    ...
    public void setKeyboardType(ReactEditText reactEditText, @Nullable String str) {
        int i = KEYBOARD_TYPE_NUMERIC.equalsIgnoreCase(str) ? INPUT_TYPE_KEYBOARD_NUMBERED : KEYBOARD_TYPE_EMAIL_ADDRESS.equalsIgnoreCase(str) ? 33 : KEYBOARD_TYPE_PHONE_PAD.equalsIgnoreCase(str) ? 3 : 1;
    ...
    public Map getExportedViewConstants() {
        return MapBuilder.m138of("AutoCapitalizationType", MapBuilder.m141of("none", Integer.valueOf(0), "characters", Integer.valueOf(4096), "words", Integer.valueOf(8192), "sentences", Integer.valueOf(16384)));
    }
}
