...
public class ReactImageView extends GenericDraweeView {
    ...
    public void setBlurRadius(float f) {
        if (f == 0.0f) {
            ...
            this.mIterativeBoxBlurPostProcessor = new IterativeBoxBlurPostProcessor((int) PixelUtil.toPixelFromDIP(f));
        }
        this.mIsDirty = true;
    }
            ...
            if (!hasMultipleSources() || (getWidth() > 0 && getHeight() > 0)) {
                ...
                if (this.mImageSource != null) {
                    ...
                    if (!shouldResize || (getWidth() > 0 && getHeight() > 0)) {
                        ...
                        Postprocessor postprocessor = z ? this.mRoundedCornerPostprocessor : this.mIterativeBoxBlurPostProcessor != null ? this.mIterativeBoxBlurPostProcessor : null;
                        if (shouldResize) {
