...
public class ReactPicker extends Spinner {
    ...
    private final Runnable measureAndLayout = new Runnable() {
        public void run() {
            ReactPicker.this.measure(MeasureSpec.makeMeasureSpec(ReactPicker.this.getWidth(), ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(ReactPicker.this.getHeight(), ErrorDialogData.SUPPRESSED));
