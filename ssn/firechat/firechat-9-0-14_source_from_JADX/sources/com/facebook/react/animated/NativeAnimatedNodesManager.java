...
class NativeAnimatedNodesManager implements EventDispatcherListener {
    ...
    public void createAnimatedNode(int i, ReadableMap readableMap) {
        ...
        if ("style".equals(string)) {
            ...
            sb2.append("Unsupported node type: ");
            sb2.append(string);
    ...
    public void startAnimatingNode(int i, int i2, ReadableMap readableMap, Callback callback) {
        ...
        if (animatedNode == null) {
            ...
            StringBuilder sb2 = new StringBuilder();
            sb2.append("Animated node should be of type ");
            ...
            if ("frames".equals(string)) {
                ...
                sb3.append("Unsupported animation type: ");
                sb3.append(string);
    ...
    public void addAnimatedEventToView(int i, String str, ReadableMap readableMap) {
        ...
        if (animatedNode == null) {
            ...
            StringBuilder sb2 = new StringBuilder();
            sb2.append("Animated node connected to event should beof type ");
            sb2.append(ValueAnimatedNode.class.getName());
            throw new JSApplicationIllegalArgumentException(sb2.toString());
        } else {
            ...
            if (this.mEventDrivers.containsKey(sb4)) {
                ((List) this.mEventDrivers.get(sb4)).add(eventAnimationDriver);
                return;
            }
            ArrayList arrayList2 = new ArrayList(1);
            arrayList2.add(eventAnimationDriver);
            this.mEventDrivers.put(sb4, arrayList2);
        }
    }
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            if (animatedNode5 instanceof PropsAnimatedNode) {
                try {
                    ...
                    FLog.m66e(ReactConstants.TAG, "Native animation workaround, frame lost as result of race condition", (Throwable) e);
                }
            }
