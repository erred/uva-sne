...
public class ReactContext extends ContextWrapper {
    ...
    public void initializeWithInstance(CatalystInstance catalystInstance) {
        if (catalystInstance == null) {
            ...
            this.mUiBackgroundMessageQueueThread = reactQueueConfiguration.getUIBackgroundQueueThread();
    ...
    public void runOnUiBackgroundQueueThread(Runnable runnable) {
        ((MessageQueueThread) Assertions.assertNotNull(this.mUiBackgroundMessageQueueThread)).runOnQueue(runnable);
    }
