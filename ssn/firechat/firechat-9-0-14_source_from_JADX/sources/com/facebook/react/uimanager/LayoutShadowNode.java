...
public class LayoutShadowNode extends ReactShadowNodeImpl {
    ...
    private static class MutableYogaValue {
        ...
        public void setFromDynamic(Dynamic dynamic) {
            if (dynamic.isNull()) {
                ...
                if (asString.equals(ReactScrollViewHelper.AUTO)) {
    ...
    public void setMinWidth(Dynamic dynamic) {
        if (!isVirtual()) {
            this.mTempYogaValue.setFromDynamic(dynamic);
            int i = C09731.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i != 4) {
                switch (i) {
                    case 1:
                    case 2:
    ...
    public void setMargins(int i, Dynamic dynamic) {
        if (!isVirtual()) {
            ...
            switch (this.mTempYogaValue.unit) {
                case POINT:
                case UNDEFINED:
                    setMargin(ViewProps.PADDING_MARGIN_SPACING_TYPES[i], this.mTempYogaValue.value);
                    break;
                case AUTO:
                    setMarginAuto(ViewProps.PADDING_MARGIN_SPACING_TYPES[i]);
                    break;
                case PERCENT:
                    setMarginPercent(ViewProps.PADDING_MARGIN_SPACING_TYPES[i], this.mTempYogaValue.value);
                    break;
            }
            dynamic.recycle();
        }
    ...
    public void setPaddings(int i, Dynamic dynamic) {
        if (!isVirtual()) {
            this.mTempYogaValue.setFromDynamic(dynamic);
            int i2 = C09731.$SwitchMap$com$facebook$yoga$YogaUnit[this.mTempYogaValue.unit.ordinal()];
            if (i2 != 4) {
                switch (i2) {
                    case 1:
                    case 2:
                        setPadding(ViewProps.PADDING_MARGIN_SPACING_TYPES[i], this.mTempYogaValue.value);
                        break;
                }
            } else {
                setPaddingPercent(ViewProps.PADDING_MARGIN_SPACING_TYPES[i], this.mTempYogaValue.value);
            }
            dynamic.recycle();
        }
    }
        ...
        if (!isVirtual()) {
            ...
            if (i2 != 4) {
                switch (i2) {
                    case 1:
                    case 2:
                        setPosition(ViewProps.POSITION_SPACING_TYPES[i], this.mTempYogaValue.value);
                        break;
                }
            } else {
                setPositionPercent(ViewProps.POSITION_SPACING_TYPES[i], this.mTempYogaValue.value);
            }
            dynamic.recycle();
        }
    }
