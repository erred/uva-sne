                ...
                try {
                    if (!response.isSuccessful()) {
                        ...
                        try {
                            ...
                            FLog.m106w(OkHttpNetworkFetcher.TAG, "Exception when closing response body", (Throwable) e);
                        }
                        return;
                    }
                    ...
                    try {
                        ...
                        FLog.m106w(OkHttpNetworkFetcher.TAG, "Exception when closing response body", (Throwable) e2);
                    }
                } catch (Exception e3) {
                    ...
                    try {
                        ...
                        FLog.m106w(OkHttpNetworkFetcher.TAG, "Exception when closing response body", (Throwable) e4);
                    }
                }
            }
