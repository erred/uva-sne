...
public class PostprocessorProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private class PostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> {
        ...
        private void updateSourceImageRef(@javax.annotation.Nullable com.facebook.common.references.CloseableReference<com.facebook.imagepipeline.image.CloseableImage> r2, boolean r3) {
            /*
                r1 = this;
                monitor-enter(r1)
            ...
            L_0x0007:
                ...
                r1.mIsLast = r3     // Catch:{ all -> 0x0022 }
                r2 = 1
            ...
            PostprocessorProducer.this.mExecutor.execute(new Runnable() {
                public void run() {
                    ...
                    synchronized (PostprocessorConsumer.this) {
                        ...
                        access$400 = PostprocessorConsumer.this.mIsLast;
        ...
        private Map<String, String> getExtraMap(ProducerListener producerListener, String str, Postprocessor postprocessor) {
            ...
            return ImmutableMap.m37of(PostprocessorProducer.POSTPROCESSOR, postprocessor.getName());
        }
        ...
        private CloseableReference<CloseableImage> postprocessInternal(CloseableImage closeableImage) {
            ...
            try {
                return CloseableReference.m129of(new CloseableStaticBitmap(process, closeableImage.getQualityInfo(), closeableStaticBitmap.getRotationAngle()));
            } finally {
