...
public class DefaultImageDecoder implements ImageDecoder {
    ...
    public DefaultImageDecoder(AnimatedImageFactory animatedImageFactory, PlatformDecoder platformDecoder, Config config) {
        this(animatedImageFactory, platformDecoder, config, null);
    }

    public DefaultImageDecoder(AnimatedImageFactory animatedImageFactory, PlatformDecoder platformDecoder, Config config, @Nullable Map<ImageFormat, ImageDecoder> map) {
    ...
    public CloseableImage decodeGif(EncodedImage encodedImage, ImageDecodeOptions imageDecodeOptions) {
        ...
        try {
            ...
            CloseableStaticBitmap decodeStaticImage = decodeStaticImage(encodedImage, imageDecodeOptions);
