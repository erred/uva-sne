...
public class ProducerFactory {
    ...
    public ProducerFactory(Context context, ByteArrayPool byteArrayPool, ImageDecoder imageDecoder, ProgressiveJpegConfig progressiveJpegConfig, boolean z, boolean z2, boolean z3, ExecutorSupplier executorSupplier, PooledByteBufferFactory pooledByteBufferFactory, MemoryCache<CacheKey, CloseableImage> memoryCache, MemoryCache<CacheKey, PooledByteBuffer> memoryCache2, BufferedDiskCache bufferedDiskCache, BufferedDiskCache bufferedDiskCache2, MediaVariationsIndex mediaVariationsIndex, @Nullable MediaIdExtractor mediaIdExtractor, CacheKeyFactory cacheKeyFactory, PlatformBitmapFactory platformBitmapFactory, int i) {
        BufferedDiskCache bufferedDiskCache3 = bufferedDiskCache;
        ...
        this.mSmallImageBufferedDiskCache = bufferedDiskCache4;
        this.mMediaVariationsIndex = mediaVariationsIndex;
        this.mMediaIdExtractor = mediaIdExtractor;
        this.mCacheKeyFactory = cacheKeyFactory2;
        this.mPlatformBitmapFactory = platformBitmapFactory;
        if (i2 > 0) {
            this.mMainDiskCachePolicy = new SplitCachesByImageSizeDiskCachePolicy(bufferedDiskCache3, bufferedDiskCache4, cacheKeyFactory2, i2);
        } else {
            this.mMainDiskCachePolicy = new SmallCacheIfRequestedDiskCachePolicy(bufferedDiskCache3, bufferedDiskCache4, cacheKeyFactory2);
        }
    }
    ...
    public MediaVariationsFallbackProducer newMediaVariationsProducer(Producer<EncodedImage> producer) {
        MediaVariationsFallbackProducer mediaVariationsFallbackProducer = new MediaVariationsFallbackProducer(this.mDefaultBufferedDiskCache, this.mSmallImageBufferedDiskCache, this.mCacheKeyFactory, this.mMediaVariationsIndex, this.mMediaIdExtractor, this.mMainDiskCachePolicy, producer);
        return mediaVariationsFallbackProducer;
    }
