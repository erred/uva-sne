...
public class ImageFormatChecker {
    ...
    public ImageFormat determineImageFormat(InputStream inputStream) throws IOException {
        ...
        if (this.mCustomImageFormatCheckers != null) {
            for (FormatChecker determineFormat : this.mCustomImageFormatCheckers) {
                ImageFormat determineFormat2 = determineFormat.determineFormat(bArr, readHeaderFromStream);
                if (determineFormat2 != null && determineFormat2 != ImageFormat.UNKNOWN) {
                    return determineFormat2;
                }
            }
        }
        ImageFormat determineFormat3 = this.mDefaultFormatChecker.determineFormat(bArr, readHeaderFromStream);
        if (determineFormat3 == null) {
            determineFormat3 = ImageFormat.UNKNOWN;
        }
