...
public class DraweeTransition extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (rect == null || rect2 == null || this.mFromScale == this.mToScale) {
            return null;
        }
        final GenericDraweeView genericDraweeView = (GenericDraweeView) transitionValues.view;
        final InterpolatingScaleType interpolatingScaleType = new InterpolatingScaleType(this.mFromScale, this.mToScale, rect, rect2);
