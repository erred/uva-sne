            ...
            case OVERLAY_COLOR:
                ...
                if (this.mIsCircle) {
                    ...
                    if (width > 0.0f) {
                        ...
                        canvas2.drawRect((float) bounds.left, (float) bounds.top, ((float) bounds.left) + width, (float) bounds.bottom, this.mPaint);
                        canvas2.drawRect(((float) bounds.right) - width, (float) bounds.top, (float) bounds.right, (float) bounds.bottom, this.mPaint);
                    }
                    if (height > 0.0f) {
                        Canvas canvas3 = canvas;
                        canvas3.drawRect((float) bounds.left, (float) bounds.top, (float) bounds.right, ((float) bounds.top) + height, this.mPaint);
                        canvas3.drawRect((float) bounds.left, ((float) bounds.bottom) - height, (float) bounds.right, (float) bounds.bottom, this.mPaint);
                        break;
                    }
                }
                break;
