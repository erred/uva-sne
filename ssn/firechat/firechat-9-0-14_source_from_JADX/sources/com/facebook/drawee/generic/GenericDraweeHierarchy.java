...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
    ...
    @Nullable
    private Drawable buildActualImageBranch(Drawable drawable, @Nullable ScaleType scaleType, @Nullable PointF pointF, @Nullable Matrix matrix, @Nullable ColorFilter colorFilter) {
