    ...
    private void listenOnAddress(String str) throws IOException {
        ...
        while (!Thread.interrupted()) {
            try {
                ...
                LogUtil.m175w((Throwable) e, "I/O error");
            } catch (InterruptedIOException unused) {
            } catch (IOException e2) {
                LogUtil.m175w((Throwable) e2, "I/O error initialising connection thread");
            }
        }
        StringBuilder sb3 = new StringBuilder();
        sb3.append("Server shutdown on @");
        sb3.append(str);
        LogUtil.m165i(sb3.toString());
    }
        ...
        while (true) {
            try {
                if (LogUtil.isLoggable(3)) {
                    ...
                    sb.append(str);
                    LogUtil.m157d(sb.toString());
                }
                return new LocalServerSocket(str);
            } catch (BindException e) {
                LogUtil.m175w((Throwable) e, "Binding error, sleep 1000 ms...");
                if (th == null) {
                    th = e;
                }
