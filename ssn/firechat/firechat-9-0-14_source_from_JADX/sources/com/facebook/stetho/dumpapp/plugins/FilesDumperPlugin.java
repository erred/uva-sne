...
public class FilesDumperPlugin implements DumperPlugin {
    ...
    private void doDownload(java.io.OutputStream r5, java.util.Iterator<java.lang.String> r6) throws com.facebook.stetho.dumpapp.DumpUsageException {
        ...
        L_0x0021:
            java.lang.String r6 = "-"
            boolean r6 = r6.equals(r0)     // Catch:{ IOException -> 0x0079 }
            if (r6 == 0) goto L_0x002a
            goto L_0x0033
        L_0x002a:
            java.io.FileOutputStream r5 = new java.io.FileOutputStream     // Catch:{ IOException -> 0x0079 }
            java.io.File r6 = resolvePossibleSdcardPath(r0)     // Catch:{ IOException -> 0x0079 }
            r5.<init>(r6)     // Catch:{ IOException -> 0x0079 }
        L_0x0033:
            java.util.zip.ZipOutputStream r6 = new java.util.zip.ZipOutputStream     // Catch:{ IOException -> 0x0079 }
            java.io.BufferedOutputStream r0 = new java.io.BufferedOutputStream     // Catch:{ IOException -> 0x0079 }
            r0.<init>(r5)     // Catch:{ IOException -> 0x0079 }
            r6.<init>(r0)     // Catch:{ IOException -> 0x0079 }
            r0 = 2048(0x800, float:2.87E-42)
            byte[] r0 = new byte[r0]     // Catch:{ all -> 0x006f }
            int r2 = r1.size()     // Catch:{ all -> 0x006f }
            if (r2 <= 0) goto L_0x0057
            int r2 = r1.size()     // Catch:{ all -> 0x006f }
            java.io.File[] r2 = new java.io.File[r2]     // Catch:{ all -> 0x006f }
            java.lang.Object[] r1 = r1.toArray(r2)     // Catch:{ all -> 0x006f }
            java.io.File[] r1 = (java.io.File[]) r1     // Catch:{ all -> 0x006f }
            r4.addFiles(r6, r0, r1)     // Catch:{ all -> 0x006f }
            goto L_0x0064
        L_0x0057:
            android.content.Context r1 = r4.mContext     // Catch:{ all -> 0x006f }
            java.io.File r1 = getBaseDir(r1)     // Catch:{ all -> 0x006f }
            java.io.File[] r1 = r1.listFiles()     // Catch:{ all -> 0x006f }
            r4.addFiles(r6, r0, r1)     // Catch:{ all -> 0x006f }
        L_0x0064:
        ...
        L_0x0068:
            r6 = move-exception
            r0 = 0
            com.facebook.stetho.common.Util.close(r5, r0)     // Catch:{ IOException -> 0x0079 }
        ...
        L_0x0074:
            r6 = 1
            com.facebook.stetho.common.Util.close(r5, r6)     // Catch:{ IOException -> 0x0079 }
        L_0x0078:
