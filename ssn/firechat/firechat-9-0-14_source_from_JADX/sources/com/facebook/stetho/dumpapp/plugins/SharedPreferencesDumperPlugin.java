...
public class SharedPreferencesDumperPlugin implements DumperPlugin {
    ...
    private enum Type {
        ...
        @Nullable
        /* renamed from: of */
        public static Type m177of(String str) {
            Type[] values;
    ...
    private void doWrite(List<String> list) throws DumpUsageException {
        ...
        Type of = Type.m177of(nextArg(it, "Expected <type>"));
        if (of == null) {
            throw new DumpUsageException(Type.appendNamesList(new StringBuilder(str), ", ").toString());
        }
