...
public class DOMStorage implements ChromeDevtoolsDomain {
    ...
    public void setDOMStorageItem(com.facebook.stetho.inspector.jsonrpc.JsonRpcPeer r10, org.json.JSONObject r11) throws org.json.JSONException, com.facebook.stetho.inspector.jsonrpc.JsonRpcException {
        /*
            ...
            com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException r3 = new com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r4.<init>()     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.String r5 = "Unsupported: cannot add new key "
            r4.append(r5)     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r4.append(r0)     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.String r5 = " due to lack of type inference"
            r4.append(r5)     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.String r4 = r4.toString()     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r3.<init>(r4)     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            throw r3     // Catch:{ DOMStorageAssignmentException -> 0x004f }
        L_0x004f:
            r3 = move-exception
            goto L_0x0081
        L_0x0051:
            android.content.SharedPreferences$Editor r4 = r1.edit()     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.Object r5 = com.facebook.stetho.inspector.domstorage.SharedPreferencesHelper.valueFromString(r11, r2)     // Catch:{ IllegalArgumentException -> 0x0060 }
            assignByType(r4, r0, r5)     // Catch:{ IllegalArgumentException -> 0x0060 }
            r4.apply()     // Catch:{ IllegalArgumentException -> 0x0060 }
            goto L_0x00a3
        L_0x0060:
            com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException r4 = new com.facebook.stetho.inspector.protocol.module.DOMStorage$DOMStorageAssignmentException     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.util.Locale r5 = java.util.Locale.US     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.String r6 = "Type mismatch setting %s to %s (expected %s)"
            r7 = 3
            java.lang.Object[] r7 = new java.lang.Object[r7]     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r7[r3] = r0     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r3 = 1
            r7[r3] = r11     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r3 = 2
            java.lang.Class r8 = r2.getClass()     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.String r8 = r8.getSimpleName()     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r7[r3] = r8     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            java.lang.String r3 = java.lang.String.format(r5, r6, r7)     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            r4.<init>(r3)     // Catch:{ DOMStorageAssignmentException -> 0x004f }
            throw r4     // Catch:{ DOMStorageAssignmentException -> 0x004f }
        L_0x0081:
