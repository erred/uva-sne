...
public class Network implements ChromeDevtoolsDomain {
    ...
    public static class RequestWillBeSentParams {
        ...
        @JsonProperty
        public C1086Response redirectResponse;
        @JsonProperty(required = true)
    ...
    /* renamed from: com.facebook.stetho.inspector.protocol.module.Network$Response */
    public static class C1086Response {
        @JsonProperty(required = true)
