...
public class DOM implements ChromeDevtoolsDomain {
    ...
    private final class DocumentUpdateListener implements UpdateListener {
        ...
        public void onInspectRequested(Object obj) {
            ...
            if (nodeIdForElement == null) {
                LogUtil.m158d("DocumentProvider.Listener.onInspectRequested() called for a non-mapped node: element=%s", obj);
                return;
            }
    ...
    private static class RGBAColor {
        ...
        public int getColor() {
            int i = -1;
            if (this.f93a != null) {
                long round = Math.round(this.f93a.doubleValue() * 255.0d);
                if (round < 0) {
                    i = 0;
                } else if (round < 255) {
                    i = (byte) ((int) round);
            ...
            return Color.argb(i, this.f96r, this.f95g, this.f94b);
        }
    }
    ...
    public void highlightNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (highlightNodeRequest.nodeId == null) {
            LogUtil.m173w("DOM.highlightNode was not given a nodeId; JS objectId is not supported");
            return;
        }
        final RGBAColor rGBAColor = highlightNodeRequest.highlightConfig.contentColor;
        if (rGBAColor == null) {
            LogUtil.m173w("DOM.highlightNode was not given a color to highlight with");
        } else {
    ...
    public GetSearchResultsResponse getSearchResults(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (getSearchResultsRequest.searchId == null) {
            LogUtil.m173w("searchId may not be null");
            return null;
        }
