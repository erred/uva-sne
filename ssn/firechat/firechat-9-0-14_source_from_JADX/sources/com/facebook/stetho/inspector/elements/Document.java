        ...
        while (!this.mCachedUpdateQueue.isEmpty()) {
            ...
            while (i < size) {
                ...
                if (obj != null) {
                    ...
                    LogUtil.m162e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
            ...
            private Accumulator<Object> insertedElements = new Accumulator<Object>() {
                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C10495.this.listenerInsertedElements.add(obj);
                    }
                }
            };
            /* access modifiers changed from: private */
