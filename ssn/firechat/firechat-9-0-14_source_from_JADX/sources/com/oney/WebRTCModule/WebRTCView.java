...
public class WebRTCView extends ViewGroup {
    ...
    /* renamed from: com.oney.WebRTCModule.WebRTCView$3 */
    static /* synthetic */ class C12753 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.oney.WebRTCModule.WebRTCView.C12753.<clinit>():void");
        }
    }
    ...
    private VideoTrack getVideoTrack() {
        ...
        if (videoTrack2 == null || videoTrack2 == getVideoTrackForStreamURL(this.streamURL)) {
            return videoTrack2;
        }
        return null;
    }
    ...
    private VideoTrack getVideoTrackForStreamURL(String str) {
        if (str != null) {
            MediaStream streamForReactTag = ((C1267WebRTCModule) ((ReactContext) getContext()).getNativeModule(C1267WebRTCModule.class)).getStreamForReactTag(str);
            if (streamForReactTag != null) {
                LinkedList<VideoTrack> linkedList = streamForReactTag.videoTracks;
                if (!linkedList.isEmpty()) {
                    return (VideoTrack) linkedList.get(0);
                }
            }
        }
        return null;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!(i9 == 0 || i10 == 0)) {
            ...
            if (C12753.$SwitchMap$org$webrtc$RendererCommon$ScalingType[scalingType2.ordinal()] == 1) {
                i5 = 0;
            } else if (!(i6 == 0 || i8 == 0)) {
    ...
    private void removeRendererFromVideoTrack() {
        if (this.videoRenderer != null) {
            VideoTrack videoTrack2 = getVideoTrack();
            if (videoTrack2 != null) {
                videoTrack2.removeRenderer(this.videoRenderer);
            }
    ...
    public void setObjectFit(String str) {
        setScalingType("cover".equals(str) ? ScalingType.SCALE_ASPECT_FILL : ScalingType.SCALE_ASPECT_FIT);
    }
    ...
    public void setStreamURL(String str) {
        ...
        } else if (str.equals(this.streamURL)) {
            return;
        }
    ...
    private void setVideoTrack(VideoTrack videoTrack2) {
        if (this.videoTrack != videoTrack2) {
    ...
    private void tryAddRendererToVideoTrack() {
        if (this.videoRenderer == null) {
            VideoTrack videoTrack2 = getVideoTrack();
            if (videoTrack2 != null && ViewCompat.isAttachedToWindow(this)) {
                ...
                videoTrack2.addRenderer(this.videoRenderer);
            }
        }
    }
}
