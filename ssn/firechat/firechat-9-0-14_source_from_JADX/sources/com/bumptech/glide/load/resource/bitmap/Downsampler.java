...
public final class Downsampler {
    ...
    private Bitmap decodeFromWrappedStreams(InputStream inputStream, Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, boolean z, int i, int i2, boolean z2, DecodeCallbacks decodeCallbacks) throws IOException {
        ...
        calculateScaling(type, inputStream2, decodeCallbacks2, this.bitmapPool, downsampleStrategy, exifOrientationDegrees, i8, i9, i3, i11, options2);
        int i12 = orientation;
        String str2 = str;
        int i13 = i9;
        int i14 = i8;
        ...
        calculateConfig(inputStream2, decodeFormat, z4, isExifOrientationRequired, options2, i3, i11);
        ...
        if (Log.isLoggable(TAG, 2)) {
            i5 = i12;
            logDecode(i14, i13, str2, options3, decodeStream, i, i2, logTime);
        } else {
            i5 = i12;
        }
        Bitmap bitmap = null;
    ...
    private static void calculateScaling(ImageType imageType, InputStream inputStream, DecodeCallbacks decodeCallbacks, BitmapPool bitmapPool2, DownsampleStrategy downsampleStrategy, int i, int i2, int i3, int i4, int i5, Options options) throws IOException {
        ...
        if (f <= 0.0f) {
            ...
            sb2.append(f);
            sb2.append(" from: ");
            sb2.append(downsampleStrategy2);
            sb2.append(", source: [");
            sb2.append(i11);
            sb2.append("x");
            sb2.append(i12);
