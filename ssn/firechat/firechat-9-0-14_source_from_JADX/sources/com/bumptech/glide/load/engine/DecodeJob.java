...
class DecodeJob<R> implements FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, Poolable {
    ...
    /* JADX WARNING: type inference failed for: r12v5, types: [com.bumptech.glide.load.engine.DataCacheKey] */
    /* access modifiers changed from: 0000 */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Unknown variable types count: 1 */
    ...
    public <Z> com.bumptech.glide.load.engine.Resource<Z> onResourceDecoded(com.bumptech.glide.load.DataSource r12, @android.support.annotation.NonNull com.bumptech.glide.load.engine.Resource<Z> r13) {
        ...
        L_0x0044:
            ...
            throw r12
        L_0x0066:
            int[] r12 = com.bumptech.glide.load.engine.DecodeJob.C05471.$SwitchMap$com$bumptech$glide$load$EncodeStrategy
            int r1 = r13.ordinal()
            r12 = r12[r1]
            switch(r12) {
