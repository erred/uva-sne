...
public final class Util {
    ...
    static /* synthetic */ class C05841 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C05841.<clinit>():void");
        }
    }
    ...
    private static int getBytesPerPixel(@Nullable Config config) {
        ...
        switch (C05841.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
                return 1;
            case 2:
            case 3:
