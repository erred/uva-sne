...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
        ...
        while (true) {
            ...
            if (length >= 0) {
                if (!((Boolean) function1.invoke(Character.valueOf(charSequence2.charAt(length)))).booleanValue()) {
                    charSequence = charSequence2.subSequence(0, length + 1).toString();
                    break;
                }
            } else {
                charSequence = "";
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(@NotNull CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
                ...
                if (step <= 0 ? first >= last : first <= last) {
                    while (true) {
                        ...
                        if (str2 == null) {
                            ...
                            return TuplesKt.m228to(Integer.valueOf(first), str2);
                        }
                    }
                }
            } else {
                ...
                if (step2 <= 0 ? first2 >= last2 : first2 <= last2) {
                    while (true) {
                        ...
                        if (str4 == null) {
                            ...
                            return TuplesKt.m228to(Integer.valueOf(first2), str4);
                        }
                    }
                }
            }
        ...
        if (indexOf$default >= 0) {
            pair = TuplesKt.m228to(Integer.valueOf(indexOf$default), str5);
        }
        return pair;
    }
