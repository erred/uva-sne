...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public static final class UnsafeCursor implements Closeable {
        ...
        public int seek(long j) {
            ...
            if (j < -1 || j > this.buffer.size) {
                ...
                if (j4 - j > j - j3) {
                    while (j >= j2 + ((long) (segment2.limit - segment2.pos))) {
                        long j6 = j2 + ((long) (segment2.limit - segment2.pos));
            ...
            if (this.buffer == null) {
                ...
                if (j2 <= j3) {
                    ...
                    while (true) {
                        ...
                        if (j5 > j4) {
                            segment2.limit = (int) (((long) segment2.limit) - j4);
                            break;
                        }
                    ...
                    while (j6 > 0) {
                        ...
                        int min = (int) Math.min(j6, (long) (8192 - writableSegment.limit));
        ...
        return new InputStream() {
            ...
            public int read() {
                if (Buffer.this.size > 0) {
                    return Buffer.this.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE;
                }
                return -1;
            }
    ...
    public short readShort() {
        ...
        int i3 = i + 1;
        int i4 = i3 + 1;
        byte b = ((bArr[i] & Pdu.MANUFACTURER_DATA_PDU_TYPE) << 8) | (bArr[i3] & Pdu.MANUFACTURER_DATA_PDU_TYPE);
        this.size -= 2;
        if (i4 == i2) {
            this.head = segment.pop();
            SegmentPool.recycle(segment);
    ...
    public int readInt() {
        ...
        int i3 = i + 1;
        int i4 = i3 + 1;
        byte b = ((bArr[i] & Pdu.MANUFACTURER_DATA_PDU_TYPE) << 24) | ((bArr[i3] & Pdu.MANUFACTURER_DATA_PDU_TYPE) << 16);
        int i5 = i4 + 1;
        byte b2 = b | ((bArr[i4] & Pdu.MANUFACTURER_DATA_PDU_TYPE) << 8);
        int i6 = i5 + 1;
        byte b3 = b2 | (bArr[i5] & Pdu.MANUFACTURER_DATA_PDU_TYPE);
        this.size -= 4;
        if (i6 == i2) {
            this.head = segment.pop();
            SegmentPool.recycle(segment);
    ...
    public long indexOf(ByteString byteString, long j) throws IOException {
        ...
        if (buffer.size - j >= j) {
            while (true) {
                long j5 = j2 + ((long) (segment2.limit - segment2.pos));
                if (j5 >= j) {
                    break;
                }
        ...
        while (j8 < j6) {
            ...
            long j9 = j8 + ((long) (segment4.limit - segment4.pos));
    ...
    public long indexOfElement(ByteString byteString, long j) {
        ...
        if (byteString.size() == 2) {
            ...
            while (j2 < this.size) {
                ...
                long j6 = j2 + ((long) (segment.limit - segment.pos));
                segment = segment.next;
                j = j6;
                j2 = j;
            }
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m237of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m237of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
