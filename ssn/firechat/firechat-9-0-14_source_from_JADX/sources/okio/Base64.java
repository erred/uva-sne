...
final class Base64 {
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            int i3 = i + 1;
            bArr3[i] = bArr2[(bArr[i2] & Pdu.MANUFACTURER_DATA_PDU_TYPE) >> 2];
            int i4 = i3 + 1;
            int i5 = i2 + 1;
            bArr3[i3] = bArr2[((bArr[i2] & 3) << 4) | ((bArr[i5] & Pdu.MANUFACTURER_DATA_PDU_TYPE) >> 4)];
            int i6 = i4 + 1;
            int i7 = i2 + 2;
            bArr3[i4] = bArr2[((bArr[i5] & 15) << 2) | ((bArr[i7] & Pdu.MANUFACTURER_DATA_PDU_TYPE) >> 6)];
            i = i6 + 1;
        ...
        switch (bArr.length % 3) {
            case 1:
                int i8 = i + 1;
                bArr3[i] = bArr2[(bArr[length] & Pdu.MANUFACTURER_DATA_PDU_TYPE) >> 2];
                int i9 = i8 + 1;
            ...
            case 2:
                ...
                int i12 = i11 + 1;
                int i13 = length + 1;
                bArr3[i11] = bArr2[((bArr[length] & 3) << 4) | ((bArr[i13] & Pdu.MANUFACTURER_DATA_PDU_TYPE) >> 4)];
                int i14 = i12 + 1;
