...
public class GifDecoder {
    ...
    public void seekToTime(@IntRange(from = 0, mo107to = 2147483647L) int i, @NonNull Bitmap bitmap) {
        checkBuffer(bitmap);
        this.mGifInfoHandle.seekToTime(i, bitmap);
    }

    public void seekToFrame(@IntRange(from = 0, mo107to = 2147483647L) int i, @NonNull Bitmap bitmap) {
        checkBuffer(bitmap);
