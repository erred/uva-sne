...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size[]{new Size(160, 120), new Size(240, 160), new Size(320, 240), new Size(OlmException.EXCEPTION_CODE_INIT_SESSION_CREATION, 240), new Size(480, 320), new Size(640, 360), new Size(640, 480), new Size(768, 480), new Size(854, 480), new Size(800, OlmException.EXCEPTION_CODE_PK_ENCRYPTION_CREATION), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, OlmException.EXCEPTION_CODE_PK_ENCRYPTION_CREATION), new Size(1280, 720), new Size(1280, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)}));
