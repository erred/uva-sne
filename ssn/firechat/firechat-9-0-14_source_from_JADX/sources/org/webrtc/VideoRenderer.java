...
public class VideoRenderer {
    ...
    public static class I420Frame {
        ...
        public int rotatedWidth() {
            return this.rotationDegree % RotationOptions.ROTATE_180 == 0 ? this.width : this.height;
        }

        public int rotatedHeight() {
            return this.rotationDegree % RotationOptions.ROTATE_180 == 0 ? this.height : this.width;
        }
