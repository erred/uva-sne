...
public class BooleanUtils {
    ...
    public static String toStringOnOff(Boolean bool) {
        return toString(bool, ViewProps.f85ON, "off", null);
    }
    ...
    public static String toStringOnOff(boolean z) {
        return toString(z, ViewProps.f85ON, "off");
    }
    ...
    /* renamed from: or */
    public static boolean m301or(boolean... zArr) {
        if (zArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (zArr.length == 0) {
            throw new IllegalArgumentException("Array is empty");
    ...
    /* renamed from: or */
    public static Boolean m300or(Boolean... boolArr) {
        if (boolArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (boolArr.length == 0) {
            throw new IllegalArgumentException("Array is empty");
            ...
            try {
                return m301or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
            } catch (NullPointerException unused) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        }
