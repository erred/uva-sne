...
public class EventCountCircuitBreaker extends AbstractCircuitBreaker<Integer> {
    ...
    private boolean performStateCheck(int i) {
        ...
        do {
            ...
            checkIntervalData2 = (CheckIntervalData) this.checkIntervalData.get();
    ...
    private CheckIntervalData nextCheckIntervalData(int i, CheckIntervalData checkIntervalData2, State state, long j) {
