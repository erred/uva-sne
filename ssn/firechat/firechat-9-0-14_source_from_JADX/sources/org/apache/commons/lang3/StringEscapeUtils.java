...
public class StringEscapeUtils {
    ...
    static class CsvEscaper extends CharSequenceTranslator {
        ...
        private static final char[] CSV_SEARCH_CHARS = {CSV_DELIMITER, '\"', CharUtils.f155CR, 10};
        ...
        public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
            ...
            if (StringUtils.containsNone((CharSequence) charSequence.toString(), CSV_SEARCH_CHARS)) {
                ...
                sb.append(CSV_QUOTE_STR);
                writer.write(StringUtils.replace(charSequence2, str, sb.toString()));
                writer.write(34);
            }
        ...
        public int translate(CharSequence charSequence, int i, Writer writer) throws IOException {
            if (i != 0) {
                ...
                if (StringUtils.containsAny((CharSequence) charSequence2, CSV_SEARCH_CHARS)) {
                    ...
                    sb.append(CSV_QUOTE_STR);
                    sb.append(CSV_QUOTE_STR);
                    writer.write(StringUtils.replace(charSequence2, sb.toString(), CSV_QUOTE_STR));
                } else {
                    writer.write(charSequence.toString());
                }
                return Character.codePointCount(charSequence, 0, charSequence.length());
