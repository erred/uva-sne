...
public class EqualsBuilder implements Builder<Boolean> {
    ...
    static Pair<IDKey, IDKey> getRegisterPair(Object obj, Object obj2) {
        return Pair.m311of(new IDKey(obj), new IDKey(obj2));
    }

    static boolean isRegistered(Object obj, Object obj2) {
        Set registry = getRegistry();
        Pair registerPair = getRegisterPair(obj, obj2);
        return registry != null && (registry.contains(registerPair) || registry.contains(Pair.m311of(registerPair.getLeft(), registerPair.getRight())));
    }
    ...
    private static void reflectionAppend(java.lang.Object r4, java.lang.Object r5, java.lang.Class<?> r6, org.apache.commons.lang3.builder.EqualsBuilder r7, boolean r8, java.lang.String[] r9) {
        ...
        L_0x0007:
            ...
            java.lang.reflect.Field[] r6 = r6.getDeclaredFields()     // Catch:{ all -> 0x006b }
            r0 = 1
            java.lang.reflect.AccessibleObject.setAccessible(r6, r0)     // Catch:{ all -> 0x006b }
            r0 = 0
        L_0x0013:
            int r1 = r6.length     // Catch:{ all -> 0x006b }
            if (r0 >= r1) goto L_0x0067
            boolean r1 = r7.isEquals     // Catch:{ all -> 0x006b }
            if (r1 == 0) goto L_0x0067
            r1 = r6[r0]     // Catch:{ all -> 0x006b }
            java.lang.String r2 = r1.getName()     // Catch:{ all -> 0x006b }
            boolean r2 = org.apache.commons.lang3.ArrayUtils.contains(r9, r2)     // Catch:{ all -> 0x006b }
            if (r2 != 0) goto L_0x0064
            java.lang.String r2 = r1.getName()     // Catch:{ all -> 0x006b }
            java.lang.String r3 = "$"
            boolean r2 = r2.contains(r3)     // Catch:{ all -> 0x006b }
            if (r2 != 0) goto L_0x0064
            if (r8 != 0) goto L_0x003e
            int r2 = r1.getModifiers()     // Catch:{ all -> 0x006b }
            boolean r2 = java.lang.reflect.Modifier.isTransient(r2)     // Catch:{ all -> 0x006b }
            if (r2 != 0) goto L_0x0064
        L_0x003e:
            int r2 = r1.getModifiers()     // Catch:{ all -> 0x006b }
            boolean r2 = java.lang.reflect.Modifier.isStatic(r2)     // Catch:{ all -> 0x006b }
            if (r2 != 0) goto L_0x0064
            java.lang.Class<org.apache.commons.lang3.builder.EqualsExclude> r2 = org.apache.commons.lang3.builder.EqualsExclude.class
            boolean r2 = r1.isAnnotationPresent(r2)     // Catch:{ all -> 0x006b }
            if (r2 != 0) goto L_0x0064
            java.lang.Object r2 = r1.get(r4)     // Catch:{ IllegalAccessException -> 0x005c }
            java.lang.Object r1 = r1.get(r5)     // Catch:{ IllegalAccessException -> 0x005c }
            r7.append(r2, r1)     // Catch:{ IllegalAccessException -> 0x005c }
            goto L_0x0064
        L_0x005c:
            java.lang.InternalError r6 = new java.lang.InternalError     // Catch:{ all -> 0x006b }
