...
public class CurveFittedDistanceCalculator implements DistanceCalculator {
    ...
    public double calculateDistance(int i, double d) {
        ...
        LogManager.m260d(TAG, "calculating distance based on mRssi of %s and txPower of %s", Double.valueOf(d), Integer.valueOf(i));
        ...
        LogManager.m260d(TAG, "avg mRssi: %s distance: %s", Double.valueOf(d), Double.valueOf(d2));
        return d2;
    }
}
