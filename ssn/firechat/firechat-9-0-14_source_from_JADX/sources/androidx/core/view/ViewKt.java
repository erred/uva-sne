...
public final class ViewKt {
    ...
    @RequiresApi(17)
    public static final void updatePaddingRelative(@NotNull View view, @C0010Px int i, @C0010Px int i2, @C0010Px int i3, @C0010Px int i4) {
        view.setPaddingRelative(i, i2, i3, i4);
    }
    ...
    public static final void updatePadding(@NotNull View view, @C0010Px int i, @C0010Px int i2, @C0010Px int i3, @C0010Px int i4) {
        view.setPadding(i, i2, i3, i4);
    }

    public static final void setPadding(@NotNull View view, @C0010Px int i) {
    ...
    @NotNull
    public static /* bridge */ /* synthetic */ Bitmap toBitmap$default(View view, Config config, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    @NotNull
    public static final Bitmap toBitmap(@NotNull View view, @NotNull Config config) {
