...
final class RealCall implements Call {
    ...
    public C3012Response execute() throws IOException {
        synchronized (this) {
            if (this.executed) {
        ...
        try {
            ...
            C3012Response responseWithInterceptorChain = getResponseWithInterceptorChain();
    ...
    /* access modifiers changed from: 0000 */
    public C3012Response getResponseWithInterceptorChain() throws IOException {
