...
public final class CallServerInterceptor implements Interceptor {
    ...
    public C3012Response intercept(Chain chain) throws IOException {
        ...
        C3012Response build = builder.request(request).handshake(streamAllocation.connection().handshake()).sentRequestAtMillis(currentTimeMillis).receivedResponseAtMillis(System.currentTimeMillis()).build();
        int code = build.code();
        if (code == 100) {
