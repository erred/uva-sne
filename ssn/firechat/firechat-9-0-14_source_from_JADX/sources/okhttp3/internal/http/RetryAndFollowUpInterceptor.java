...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public C3012Response intercept(Chain chain) throws IOException {
        ...
        C3012Response response = null;
        int i = 0;
        while (!this.canceled) {
            try {
                C3012Response proceed = realInterceptorChain.proceed(request, streamAllocation2, null, null);
                C3012Response build = response != null ? proceed.newBuilder().priorResponse(response.newBuilder().body(null).build()).build() : proceed;
    ...
    private Request followUpRequest(C3012Response response, Route route) throws IOException {
        Proxy proxy;
        if (response == null) {
        ...
        switch (code) {
            ...
            case OlmException.EXCEPTION_CODE_SESSION_INIT_OUTBOUND_SESSION /*401*/:
    ...
    private int retryAfter(C3012Response response, int i) {
    ...
    private boolean sameConnection(C3012Response response, HttpUrl httpUrl) {
