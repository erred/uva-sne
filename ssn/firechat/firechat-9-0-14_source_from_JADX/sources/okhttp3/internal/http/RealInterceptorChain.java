...
public final class RealInterceptorChain implements Chain {
    ...
    public C3012Response proceed(Request request2) throws IOException {
        return proceed(request2, this.streamAllocation, this.httpCodec, this.connection);
    }

    public C3012Response proceed(Request request2, StreamAllocation streamAllocation2, HttpCodec httpCodec2, RealConnection realConnection) throws IOException {
        ...
        if (this.httpCodec != null && !this.connection.supportsUrl(request2.url())) {
            ...
            C3012Response intercept = interceptor.intercept(realInterceptorChain);
