...
final class Http2Reader implements Closeable {
    ...
    static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            byte readByte = (byte) (this.source.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE);
            this.flags = (byte) (this.source.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE);
    ...
    public boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            byte readByte = (byte) (this.source.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE);
            if (!z || readByte == 4) {
                byte readByte2 = (byte) (this.source.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE);
    ...
    private void readHeaders(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        boolean z = (b & 1) != 0;
        if ((b & 8) != 0) {
            s = (short) (this.source.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE);
        }
        if ((b & 32) != 0) {
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    static int readMedium(BufferedSource bufferedSource) throws IOException {
        return (bufferedSource.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE) | ((bufferedSource.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE) << 16) | ((bufferedSource.readByte() & Pdu.MANUFACTURER_DATA_PDU_TYPE) << 8);
    }
