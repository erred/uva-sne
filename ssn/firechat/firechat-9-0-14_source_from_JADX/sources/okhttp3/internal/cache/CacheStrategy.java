...
public final class CacheStrategy {
    @Nullable
    public final C3012Response cacheResponse;
    @Nullable
    ...
    public static class Factory {
        ...
        public Factory(long j, Request request2, C3012Response response) {
            this.nowMillis = j;
    ...
    CacheStrategy(Request request, C3012Response response) {
    ...
    public static boolean isCacheable(okhttp3.C3012Response r3, okhttp3.Request r4) {
        /*
            int r0 = r3.code()
            r1 = 0
            switch(r0) {
