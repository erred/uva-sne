...
public class CancellationTokenSource implements Closeable {
    ...
    private void cancelAfter(long r6, java.util.concurrent.TimeUnit r8) {
        ...
        L_0x0018:
            ...
            monitor-enter(r2)
            boolean r3 = r5.cancellationRequested     // Catch:{ all -> 0x0037 }
        ...
        L_0x0021:
            ...
            java.util.concurrent.ScheduledExecutorService r0 = r5.executor     // Catch:{ all -> 0x0037 }
            bolts.CancellationTokenSource$1 r1 = new bolts.CancellationTokenSource$1     // Catch:{ all -> 0x0037 }
            r1.<init>()     // Catch:{ all -> 0x0037 }
            java.util.concurrent.ScheduledFuture r6 = r0.schedule(r1, r6, r8)     // Catch:{ all -> 0x0037 }
            r5.scheduledCancellation = r6     // Catch:{ all -> 0x0037 }
        L_0x0035:
            monitor-exit(r2)     // Catch:{ all -> 0x0037 }
            return
        L_0x0037:
