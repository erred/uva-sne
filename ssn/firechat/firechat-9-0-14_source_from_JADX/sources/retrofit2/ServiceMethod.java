...
final class ServiceMethod<R, T> {
    ...
    static final class Builder<T, R> {
        ...
        public ServiceMethod build() {
            ...
            if (this.responseType == C3224Response.class || this.responseType == C3012Response.class) {
                StringBuilder sb = new StringBuilder();
                sb.append("'");
                sb.append(C3226Utils.getRawType(this.responseType).getName());
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (C3226Utils.hasUnresolvableType(type)) {
        ...
        private CallAdapter<T, R> createCallAdapter() {
            ...
            if (C3226Utils.hasUnresolvableType(genericReturnType)) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                Class rawType = C3226Utils.getRawType(type);
                this.gotQuery = true;
                if (Iterable.class.isAssignableFrom(rawType)) {
                    ...
                    return new Query(value2, this.retrofit.stringConverter(C3226Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), encoded).iterable();
                ...
                Class rawType2 = C3226Utils.getRawType(type);
                this.gotQuery = true;
                if (Iterable.class.isAssignableFrom(rawType2)) {
                    ...
                    return new QueryName(this.retrofit.stringConverter(C3226Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), encoded2).iterable();
                ...
                return new QueryMap(this.retrofit.stringConverter(C3226Utils.getParameterUpperBound(1, parameterizedType), annotationArr), ((QueryMap) annotation).encoded());
            } else if (annotation instanceof Header) {
                String value3 = ((Header) annotation).value();
                Class rawType4 = C3226Utils.getRawType(type);
                if (Iterable.class.isAssignableFrom(rawType4)) {
                    ...
                    return new Header(value3, this.retrofit.stringConverter(C3226Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr)).iterable();
                ...
                Class rawType5 = C3226Utils.getRawType(type);
                if (!Map.class.isAssignableFrom(rawType5)) {
                    throw parameterError(i, "@HeaderMap parameter type must be Map.", new Object[0]);
                }
                Type supertype2 = C3226Utils.getSupertype(type, rawType5, Map.class);
                if (!(supertype2 instanceof ParameterizedType)) {
                    throw parameterError(i, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                }
                ParameterizedType parameterizedType2 = (ParameterizedType) supertype2;
                Type parameterUpperBound2 = C3226Utils.getParameterUpperBound(0, parameterizedType2);
                ...
                return new HeaderMap(this.retrofit.stringConverter(C3226Utils.getParameterUpperBound(1, parameterizedType2), annotationArr));
                ...
                this.gotField = true;
                Class rawType6 = C3226Utils.getRawType(type);
                if (Iterable.class.isAssignableFrom(rawType6)) {
                    ...
                    return new Field(value4, this.retrofit.stringConverter(C3226Utils.getParameterUpperBound(0, (ParameterizedType) type), annotationArr), encoded3).iterable();
                ...
                Class rawType7 = C3226Utils.getRawType(type);
                if (!Map.class.isAssignableFrom(rawType7)) {
                    throw parameterError(i, "@FieldMap parameter type must be Map.", new Object[0]);
                }
                Type supertype3 = C3226Utils.getSupertype(type, rawType7, Map.class);
                if (!(supertype3 instanceof ParameterizedType)) {
                    throw parameterError(i, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                }
                ParameterizedType parameterizedType3 = (ParameterizedType) supertype3;
                Type parameterUpperBound3 = C3226Utils.getParameterUpperBound(0, parameterizedType3);
                ...
                Converter stringConverter = this.retrofit.stringConverter(C3226Utils.getParameterUpperBound(1, parameterizedType3), annotationArr);
                this.gotField = true;
                ...
                Class rawType8 = C3226Utils.getRawType(type);
                if (!value5.isEmpty()) {
                    StringBuilder sb8 = new StringBuilder();
                    sb8.append("form-data; name=\"");
                    sb8.append(value5);
                    sb8.append("\"");
                    Headers of = Headers.m235of("Content-Disposition", sb8.toString(), "Content-Transfer-Encoding", part.encoding());
                    if (Iterable.class.isAssignableFrom(rawType8)) {
                        ...
                        Type parameterUpperBound4 = C3226Utils.getParameterUpperBound(0, (ParameterizedType) type);
                        if (!MultipartBody.Part.class.isAssignableFrom(C3226Utils.getRawType(parameterUpperBound4))) {
                    ...
                    } else if (MultipartBody.Part.class.isAssignableFrom(C3226Utils.getRawType(C3226Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
                ...
                this.gotPart = true;
                Class rawType9 = C3226Utils.getRawType(type);
                if (!Map.class.isAssignableFrom(rawType9)) {
                    throw parameterError(i, "@PartMap parameter type must be Map.", new Object[0]);
                }
                Type supertype4 = C3226Utils.getSupertype(type, rawType9, Map.class);
                if (!(supertype4 instanceof ParameterizedType)) {
                    throw parameterError(i, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                }
                ParameterizedType parameterizedType4 = (ParameterizedType) supertype4;
                Type parameterUpperBound5 = C3226Utils.getParameterUpperBound(0, parameterizedType4);
                ...
                Type parameterUpperBound6 = C3226Utils.getParameterUpperBound(1, parameterizedType4);
                if (!MultipartBody.Part.class.isAssignableFrom(C3226Utils.getRawType(parameterUpperBound6))) {
