...
final class C3226Utils {
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && C3226Utils.equals(this, (GenericArrayType) obj);
        }
        ...
        public String toString() {
            ...
            sb.append(C3226Utils.typeToString(this.componentType));
            sb.append("[]");
            return sb.toString();
        }
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(@Nullable Type type, Type type2, Type... typeArr) {
            ...
            for (Type type3 : typeArr) {
                C3226Utils.checkNotNull(type3, "typeArgument == null");
                C3226Utils.checkNotPrimitive(type3);
            }
            this.ownerType = type;
            this.rawType = type2;
        ...
        public boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && C3226Utils.equals(this, (ParameterizedType) obj);
        }
        ...
        public String toString() {
            if (this.typeArguments.length == 0) {
                return C3226Utils.typeToString(this.rawType);
            }
            StringBuilder sb = new StringBuilder((this.typeArguments.length + 1) * 30);
            sb.append(C3226Utils.typeToString(this.rawType));
            sb.append("<");
            sb.append(C3226Utils.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                sb.append(", ");
                sb.append(C3226Utils.typeToString(this.typeArguments[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            if (typeArr2.length > 1) {
                ...
                C3226Utils.checkNotPrimitive(typeArr2[0]);
                ...
                C3226Utils.checkNotPrimitive(typeArr[0]);
        ...
        public Type[] getLowerBounds() {
            if (this.lowerBound == null) {
                return C3226Utils.EMPTY_TYPE_ARRAY;
            }
            return new Type[]{this.lowerBound};
        }

        public boolean equals(Object obj) {
            return (obj instanceof WildcardType) && C3226Utils.equals(this, (WildcardType) obj);
        }
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder sb = new StringBuilder();
                sb.append("? super ");
                sb.append(C3226Utils.typeToString(this.lowerBound));
                return sb.toString();
                ...
                sb2.append("? extends ");
                sb2.append(C3226Utils.typeToString(this.upperBound));
                return sb2.toString();
            }
        }
    }
    ...
    static java.lang.reflect.Type resolve(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10) {
        ...
        L_0x00cc:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: retrofit2.C3226Utils.resolve(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
