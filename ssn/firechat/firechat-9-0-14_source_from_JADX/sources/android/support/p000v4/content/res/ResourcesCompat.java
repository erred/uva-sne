...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r14, android.content.res.Resources r15, android.util.TypedValue r16, int r17, int r18, @android.support.annotation.Nullable android.support.p000v4.content.res.ResourcesCompat.FontCallback r19, @android.support.annotation.Nullable android.os.Handler r20, boolean r21) {
        ...
        L_0x0053:
            return r12
        L_0x0054:
            android.graphics.Typeface r1 = android.support.p000v4.graphics.TypefaceCompat.findFromCache(r3, r4, r5)
        ...
        L_0x0060:
            ...
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = android.support.p000v4.content.res.FontResourcesParserCompat.parse(r1, r3)     // Catch:{ XmlPullParserException -> 0x00b7, IOException -> 0x009e }
        ...
        L_0x0083:
            ...
            r7 = r10
            r8 = r21
            android.graphics.Typeface r1 = android.support.p000v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch:{ XmlPullParserException -> 0x00b7, IOException -> 0x009e }
            return r1
        L_0x008d:
            r1 = r14
            android.graphics.Typeface r1 = android.support.p000v4.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r3, r4, r11, r5)     // Catch:{ XmlPullParserException -> 0x00b7, IOException -> 0x009e }
