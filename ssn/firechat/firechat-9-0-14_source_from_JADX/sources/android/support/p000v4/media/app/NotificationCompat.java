...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0099R.layout.notification_template_media_custom;
            }
        ...
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0099R.layout.notification_template_big_media_narrow_custom : C0099R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                i = this.mBuilder.mContext.getResources().getColor(C0099R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0099R.C0101id.status_bar_latest_event_content, "setBackgroundColor", i);
        }
    }
    ...
    public static class MediaStyle extends Style {
        ...
        public RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0099R.C0101id.media_actions);
            if (i > 0) {
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    applyStandardTemplate.addView(C0099R.C0101id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0099R.C0101id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0099R.C0101id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0099R.C0101id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0099R.C0101id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0099R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0099R.C0101id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0099R.C0101id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0099R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0099R.C0101id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0099R.C0101id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0099R.C0101id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        /* access modifiers changed from: 0000 */
        public int getContentViewLayoutResource() {
            return C0099R.layout.notification_template_media;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0099R.C0101id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0099R.C0101id.cancel_action, 0);
        ...
        /* access modifiers changed from: 0000 */
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0099R.layout.notification_template_big_media_narrow : C0099R.layout.notification_template_big_media;
        }
    }
