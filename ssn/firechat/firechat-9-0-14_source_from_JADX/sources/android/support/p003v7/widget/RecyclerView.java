...
import android.support.p003v7.recyclerview.C0353R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0353R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0353R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0353R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0353R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0353R.styleable.RecyclerView_stackFromEnd, false);
    ...
    public final class Recycler {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public android.support.p003v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r18, boolean r19, long r20) {
            /*
                r17 = this;
                r6 = r17
                r3 = r18
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            L_0x0051:
                ...
                android.support.p000v4.p002os.TraceCompat.beginSection(r3)
                android.support.v7.widget.RecyclerView r3 = android.support.p003v7.widget.RecyclerView.this
                android.support.v7.widget.RecyclerView r5 = android.support.p003v7.widget.RecyclerView.this
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0353R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0353R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0353R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0353R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0353R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0353R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0353R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0353R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    private void pullGlows(float r7, float r8, float r9, float r10) {
        /*
            ...
            float r9 = r9 / r5
            float r9 = r2 - r9
            android.support.p000v4.widget.EdgeEffectCompat.onPull(r1, r4, r9)
        L_0x001f:
            r9 = 1
            goto L_0x003c
        L_0x0021:
        ...
        L_0x003c:
            ...
            float r2 = (float) r2
            float r7 = r7 / r2
            android.support.p000v4.widget.EdgeEffectCompat.onPull(r9, r1, r7)
            goto L_0x0072
        L_0x0056:
            int r1 = (r10 > r0 ? 1 : (r10 == r0 ? 0 : -1))
            ...
            float r7 = r7 / r4
            float r2 = r2 - r7
            android.support.p000v4.widget.EdgeEffectCompat.onPull(r9, r1, r2)
            goto L_0x0072
        L_0x0071:
            r3 = r9
        L_0x0072:
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0353R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0353R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0353R.dimen.fastscroll_margin));
    }
