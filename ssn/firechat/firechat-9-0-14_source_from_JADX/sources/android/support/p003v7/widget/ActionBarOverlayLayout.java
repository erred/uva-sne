...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0349R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = OlmException.EXCEPTION_CODE_PK_ENCRYPTION_CREATION;
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0349R.C0351id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0349R.C0351id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0349R.C0351id.action_bar));
        }
    }
