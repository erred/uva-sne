...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        /* renamed from: P */
        private final AlertParams f22P;
        ...
        public Builder(@NonNull Context context, @StyleRes int i) {
            this.f22P = new AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i)));
            this.mTheme = i;
        }
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int i) {
        ...
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0349R.attr.alertDialogTheme, typedValue, true);
