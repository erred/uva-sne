...
public class ConstraintSet {
    ...
    static {
        mapToConstant.append(C0015R.styleable.ConstraintSet_layout_constraintLeft_toLeftOf, 25);
        ...
        mapToConstant.append(C0015R.styleable.ConstraintSet_layout_constraintLeft_creator, 64);
        mapToConstant.append(C0015R.styleable.ConstraintSet_layout_constraintTop_creator, 64);
        mapToConstant.append(C0015R.styleable.ConstraintSet_layout_constraintRight_creator, 64);
        mapToConstant.append(C0015R.styleable.ConstraintSet_layout_constraintBottom_creator, 64);
        mapToConstant.append(C0015R.styleable.ConstraintSet_layout_constraintBaseline_creator, 64);
