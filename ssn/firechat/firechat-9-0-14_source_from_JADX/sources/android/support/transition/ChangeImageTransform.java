...
public class ChangeImageTransform extends Transition {
    ...
    static /* synthetic */ class C01183 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.transition.ChangeImageTransform.C01183.<clinit>():void");
        }
    }
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C01183.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
