...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        sb3.append(this.f15mX[0]);
        sb3.append(",");
        sb3.append(this.f16mY[0]);
        sb3.append(" end:");
        int i6 = min - 1;
        sb3.append(this.f15mX[i6]);
        sb3.append(",");
        sb3.append(this.f16mY[i6]);
    ...
    public float getInterpolation(float f) {
        ...
        float f3 = (f - this.f15mX[i]) / f2;
        float f4 = this.f16mY[i];
        return f4 + (f3 * (this.f16mY[length] - f4));
    }
}
