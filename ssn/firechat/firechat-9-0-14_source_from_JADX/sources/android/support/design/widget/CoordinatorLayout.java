...
import android.support.coreui.C0021R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            typedArray = context.obtainStyledAttributes(attributeSet, C0021R.styleable.CoordinatorLayout, 0, C0021R.style.Widget_Support_CoordinatorLayout);
        } else {
            typedArray = context.obtainStyledAttributes(attributeSet, C0021R.styleable.CoordinatorLayout, i, 0);
        }
        int resourceId = typedArray.getResourceId(C0021R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = typedArray.getDrawable(C0021R.styleable.CoordinatorLayout_statusBarBackground);
        typedArray.recycle();
        setupForInsets();
    ...
    public void onMeasure(int r32, int r33) {
        /*
            ...
            int r10 = android.support.p000v4.view.ViewCompat.getLayoutDirection(r31)
            r2 = 1
        ...
        L_0x0022:
            ...
            boolean r3 = android.support.p000v4.view.ViewCompat.getFitsSystemWindows(r31)
            if (r3 == 0) goto L_0x004b
            r19 = 1
            goto L_0x004d
        L_0x004b:
        ...
        L_0x0072:
            ...
            int r2 = android.support.p000v4.view.GravityCompat.getAbsoluteGravity(r2, r10)
            r2 = r2 & 7
            r22 = r3
            r3 = 3
        ...
        L_0x00c4:
            ...
            boolean r0 = android.support.p000v4.view.ViewCompat.getFitsSystemWindows(r1)
