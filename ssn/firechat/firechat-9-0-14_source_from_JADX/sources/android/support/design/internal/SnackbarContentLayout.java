...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mMaxWidth = obtainStyledAttributes.getDimensionPixelSize(C0027R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C0027R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C0027R.C0029id.snackbar_text);
        this.mActionView = (Button) findViewById(C0027R.C0029id.snackbar_action);
    }
    ...
    public void onMeasure(int r8, int r9) {
        ...
        L_0x001a:
            ...
            int r1 = android.support.design.C0027R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = android.support.design.C0027R.dimen.design_snackbar_padding_vertical
